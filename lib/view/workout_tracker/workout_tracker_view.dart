...
class _WorkoutTrackerViewState extends State<WorkoutTrackerView> {
                    ...
                    lineTouchData: LineTouchData(
                      ...
                      touchTooltipData: LineTouchTooltipData(
                        tooltipRoundedRadius:
                            20, // Sets the corner radius for the tooltip
  ...
  LineTouchData get lineTouchData1 => LineTouchData(
        ...
        touchTooltipData: LineTouchTooltipData(
          tooltipRoundedRadius: 20, // Sets the corner radius for the tooltip
          tooltipPadding: const EdgeInsets.all(8), // Padding inside the tooltip
          tooltipMargin: 8, // Margin between the tooltip and other elements
          getTooltipItems: (List<LineBarSpot> lineBarsSpot) {
            return lineBarsSpot.map((lineBarSpot) {
              return LineTooltipItem(
                "${lineBarSpot.x.toInt()} mins ago", // Tooltip content
                const TextStyle(
                  color: Colors.white,
                  fontSize: 10,
                  fontWeight: FontWeight.bold,
