...
class _ResultViewState extends State<ResultView> {
                        ...
                        LineChartData(
                          lineTouchData: LineTouchData(
                            ...
                            touchTooltipData: LineTouchTooltipData(
                              ...
                              tooltipMargin:
                                  8, // Margin between the tooltip and chart elements
                              getTooltipItems:
  ...
  LineTouchData get lineTouchData1 => LineTouchData(
        ...
        touchTooltipData: LineTouchTooltipData(
          tooltipRoundedRadius: 20, // Sets the corner radius
          tooltipPadding: const EdgeInsets.all(8), // Padding inside the tooltip
          tooltipMargin: 8, // Margin between the tooltip and chart elements
